    ...
    <AnimatedSection id="about">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="grid gap-10 md:grid-cols-2 items-center">
          {/* Profile photo placeholder with red glow border */}
          <div className="aspect-square rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center relative overflow-hidden group">
            ...
            <div className="absolute -inset-1 rounded-2xl bg-gradient-to-br from-red-500/20 to-orange-500/20 blur-xl opacity-50" />
