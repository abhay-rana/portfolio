  ...
  return (
    ...
    >
      ...
      <div className="mt-4 flex items-center gap-3">
        <div className="h-10 w-10 rounded-full bg-gradient-to-br from-red-500/30 to-orange-500/30 border border-white/10 flex items-center justify-center text-sm font-bold text-red-400">
